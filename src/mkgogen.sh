...
protoc --gofast_out=$TYPES,$ARGS,plugins=grpc:$OUTDIR opencensus/proto/stats/v1/stats.proto \
    ...
    && protoc --grpc-gateway_out=$TYPES,logtostderr=true,grpc_api_configuration=./opencensus/proto/agent/trace/v1/trace_service_http.yaml:$OUTDIR opencensus/proto/agent/trace/v1/trace_service.proto
